...
const authMiddleware = (role) => {
    return (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const user = yield __1.prisma_client.users.findFirst({ where: { id: payload.userId } });
            if (!user) {
            ...
            if (payload.role != role)
                return next(new exceptions_1.HttpException("Droit requis!", exceptions_1.ErrCodes.UNAUTHORIZED_ACCESS, exceptions_1.statusCodes.UNAUTHORIZED, null));
            req.user = user;
            return next();
        }
        catch (e) {
